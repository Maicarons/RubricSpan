 ...
 * 约定：不引入 emoji，保持同一笔触语言；尺寸以 className 控制（默认 h-5 w-5）。
 */
...
const paths = {
  ...
  sparkle: (
    <>
      ...
      <path d="M8 8l1.5 1.5M16 16l1.5 1.5" />
      <path d="m16 8-1.5 1.5M8 16l-1.5 1.5" />
    </>
  ),
  image: (
    <>
...
function make(name: IconName) {
  return function Icon({ className }: IconProps) {
    return <S className={className}>{paths[name]}</S>;
  };
}
...
export const IconCloudOff = make("cloudOff");
...
export const IconFileText = make("fileText");
